...
%.o: %.c ./minishell.h | $(OBJDIR)
	@echo "$(Y) compailing file $< ... done $(RESET)"
	@$(CC) $(CFLAGS) -c $<  -o $@

clean:
	@echo "$(R) cleaned $(RESET)"
	@rm -f $(OBJECTS)

fclean: clean
	@echo "$(R) fully cleaned $(RESET)"
	@rm -f $(NAME)
