...
#    Updated: 2025/04/29 10:38:45 by moel-oua         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

       
CC = gcc
CFLAGS = -Wall  -Wextra -Werror -g3 -fsanitize=address #-Wno-unused-variable -Wno-unused-parameter -Wno-maybe-uninitialized
